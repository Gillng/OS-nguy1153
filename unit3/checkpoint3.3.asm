...
.segmentdef Zeropage [min=$bf00, max=$bfff, fill]
  ...
  .label current_screen_line_25 = $a
  .label current_screen_line_45 = $a
  .label current_screen_line_46 = $a
  .label current_screen_line_47 = $a
  .label current_screen_line_48 = $a
  lda #<0
  sta.z p
  sta.z p+1
  jsr main
...
.segment Data
  MESSAGE: .text "checkpoint3.2 by nguy1153"
  .byte 0
.segment Syscall
  SYSCALL: .byte JMP
  .word syscall00
